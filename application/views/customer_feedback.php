        ...
        <div class="TTWForm-container">
            ...
            <form  class="TTWForm" name="TTWForm" method="post" novalidate="" action="mail.php" enctype="text/plain">
                ...
                <div id="field1-container" class="field f_75">
                    ...
                    <span id="field1_error" class="f_errors">Example: John Smith</span>
                ...
                <div id="field6-container" class="field f_75">
                    ...
                    <span id="field6_error" class="f_errors">Please use this format (123) 456-7890</span>
                </div>
                ...
                <div id="field5-container" class="field f_75">
                    ...
                    <span id="field5_error" class="f_errors">Example: user@domain.com</span>
                </div>


                <div id="field3-container" class="field radio-group required f_50">
                    <label for="field3-1">How did you find us?</label>
                    ...
                    <div class="option clearfix">
                        ...
                        <span class="option-title">Internet Search </span>
                    </div>
                    ...
                    <div class="option clearfix">
                        ...
                        <span class="option-title">Newspaper</span>
                    </div>


                    <div class="option clearfix">
                        <label for="how-4"></label>
                ...
                <div id="field4-container" class="field checkbox-group required f_50">
                    <label for="field4-1">Please let us know which way is most convenient to be contacted</label>
