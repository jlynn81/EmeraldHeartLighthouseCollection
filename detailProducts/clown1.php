    ...
    <section id="product_info">
        ...
        <div class="item_description">
            ...
            <div id="accordion">
                ...
                <div>
                    <p>The stars of the clowns outfit, will sooth your little ones off to sleep,
                    comfort them when they're scared, and bring joy to there face when they play.</p>
                    <ul>
                        <li>12" Tall</li>
